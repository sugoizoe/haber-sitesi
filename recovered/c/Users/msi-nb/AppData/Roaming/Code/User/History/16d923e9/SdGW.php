...
<main class="container">
  ...
  <section class="hero">
    <article class="lead">
      <img class="cover" src="uploads/amasra-hero.svg" alt="Amasra manşet görseli" onerror="this.onerror=null;this.src='https://picsum.photos/1200/640?random=3'" />
  ...
  <a class="mini" href="haber.php?id=<?= (int)$m['id'] ?>">
    <img src="uploads/amasra_thumb_<?= (int)$m['id'] ?>.svg" alt="Haber görseli" onerror="this.onerror=null;this.src='https://picsum.photos/300/220?random=' + <?= (int)$m['id'] ?>" />
    <div>
      <h3><?= h($m['baslik']) ?></h3>
      <div class="meta-row">
    ...
    <div class="cards">
      <?php foreach ($liste as $hbr): ?>
        <a href="haber.php?id=<?= (int)$hbr['id'] ?>" class="card">
          <img src="uploads/amasra_card_<?= (int)$hbr['id'] ?>.svg" alt="Haber görseli" onerror="this.onerror=null;this.src='https://picsum.photos/640/400?random=' + <?= (int)$hbr['id'] ?>" />
          <div class="pad">
            <h4><?= h($hbr['baslik']) ?></h4>
            <p><?= h($hbr['ozet']) ?></p>
          </div>
